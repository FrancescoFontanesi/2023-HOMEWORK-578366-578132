...
public class StanzaProtected {
	...
	static final protected int NON_PRESENTE = -1;
	...
	*/
    ...
    /**
     * Metodo getIndice concettualmente analogo a quello di Borsa @see Descrizione Borsa getIndice
     * @param nomeAttrezzo
	...
	*/
	public boolean hasAttrezzo(String nomeAttrezzo) {
		return getIndice(nomeAttrezzo) != NON_PRESENTE;
	}
	...
	public Attrezzo getAttrezzo(String nomeAttrezzo) {
		if(!this.hasAttrezzo(nomeAttrezzo))
			...
			return this.attrezzi[getIndice(nomeAttrezzo)];	
	}

	/**
	 * Rimuove un attrezzo dalla stanza (ricerca in base al nome).
	 * P.S. Considero due attrezzi uguali se hanno lo stesso nome
	 * @param nomeAttrezzo
	...
	public boolean removeAttrezzo(Attrezzo attrezzo) {
		...
		if(!this.hasAttrezzo(attrezzo.getNome()))
			...
			int index = getIndice(attrezzo.getNome());
